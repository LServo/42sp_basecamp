// para rodar, crie uma pasta, jogue todos os arquivos dentro e rode normalmente -> gcc -Wall -Werror -Wextra *.c -o lucas && ./lucas | cat -e
...
int main(void)
{
    ...
    if ((ret = ft_sqrt(4)) != 2)
        printf("KO, sqrt 4 is 2, got %i\n", ret);
    else if ((ret = ft_sqrt(16)) != 4)
        printf("KO, sqrt 16 is 4, got %i\n", ret);
    else if ((ret = ft_sqrt(64)) != 8)
        printf("KO, sqrt 64 is 8, got %i\n", ret);
    else if ((ret = ft_sqrt(9)) != 3)
        printf("KO, sqrt 9 is 3, got %i\n", ret);
    else if ((ret = ft_sqrt(81)) != 9)
        printf("KO, sqrt 81 is 9, got %i\n", ret);
    else if ((ret = ft_sqrt(49)) != 7)
        printf("KO, sqrt 49 is 7, got %i\n", ret);
    else if ((ret = ft_sqrt(121)) != 11)
        printf("KO, sqrt 121 is 11, got %i\n", ret);
    else if ((ret = ft_sqrt(25)) != 5)
        printf("KO, sqrt 25 is 5, got %i\n", ret);
    else if ((ret = ft_sqrt(21)) != 0)
        printf("KO, sqrt 21 is 0, got %i\n", ret);
    else if ((ret = ft_sqrt(2)) != 0)
        printf("KO, sqrt 2 is 0, got %i\n", ret);
    else if ((ret = ft_sqrt(2209)) != 47)
        printf("KO, sqrt 2209 is 47, got %i\n", ret);
    else
        printf("OK\n");

    printf("\e[1;31m-- Exercício 06: \e[0m");

    if ((ret = ft_is_prime(0)) != 0)
        printf("KO, 0 is not prime\n");
    else if ((ret = ft_is_prime(1)) != 0)
        printf("KO, 1 is not prime\n");
    else if ((ret = ft_is_prime(4)) != 0)
        printf("KO, 4 is not prime\n");
    else if ((ret = ft_is_prime(-3)) != 0)
        printf("KO, -3 is not prime\n");
    else if ((ret = ft_is_prime(-7)) != 0)
        printf("KO, -7 is not prime\n");
    else if ((ret = ft_is_prime(-8)) != 0)
        printf("KO, -8 is not prime\n");
    else if ((ret = ft_is_prime(9)) != 0)
        printf("KO, 9 is not prime\n");
    else if ((ret = ft_is_prime(50)) != 0)
        printf("KO, 50 is not prime\n");
    else if ((ret = ft_is_prime(234521)) != 0)
        printf("KO, 234521 is not prime\n");
    else if ((ret = ft_is_prime(2)) != 1)
        printf("KO, 2 is prime\n");
    else if ((ret = ft_is_prime(3)) != 1)
        printf("KO, 3 is prime\n");
    else if ((ret = ft_is_prime(11)) != 1)
        printf("KO, 11 is prime\n");
    else if ((ret = ft_is_prime(13)) != 1)
        printf("KO, 13 is prime\n");
    else if ((ret = ft_is_prime(5987)) != 1)
        printf("KO, 5987 is prime\n");
    else if ((ret = ft_is_prime(3023)) != 1)
        printf("KO, 3023 is prime\n");
    else
        printf("OK\n");
    ...
    if ((ret = ft_find_next_prime(0)) != 2)
        printf("\b\b\b\b\b\b\b\b\b\b\b\b\b\bKO, prime after 0 is 2, got %i", ret);
    else if ((ret = ft_find_next_prime(1)) != 2)
        printf("\b\b\b\b\b\b\b\b\b\b\b\b\b\bKO, prime after 1 is 2, got %i", ret);
    else if ((ret = ft_find_next_prime(2)) != 2)
        printf("\b\b\b\b\b\b\b\b\b\b\b\b\b\bKO, prime after 2 is 2, got %i", ret);
    else if ((ret = ft_find_next_prime(8)) != 11)
        printf("\b\b\b\b\b\b\b\b\b\b\b\b\b\bKO, prime after 8 is 11, got %i", ret);
    else if ((ret = ft_find_next_prime(4)) != 5)
        printf("\b\b\b\b\b\b\b\b\b\b\b\b\b\bKO, prime after 4 is 5, got %i", ret);
    else if ((ret = ft_find_next_prime(13)) != 13)
        printf("\b\b\b\b\b\b\b\b\b\b\b\b\b\bKO, prime after 4 is 5, got %i", ret);
    else if ((ret = ft_find_next_prime(5982)) != 5987)
        printf("\b\b\b\b\b\b\b\b\b\b\b\b\b\bKO, prime after 5982 is 5987, got %i", ret);
    else if ((ret = ft_find_next_prime(2000000000)) != 2000000011)
        printf("\b\b\b\b\b\b\b\b\b\b\b\b\b\bKO, prime after 2000000000 is 2000000011, got %i", ret);
    else if ((ret = ft_find_next_prime(INT_MAX - 11)) != INT_MAX)
        printf("\b\b\b\b\b\b\b\b\b\b\b\b\b\bKO, prime after INT_MAX - 11 is INT_MAX, got %i", ret);
    else if ((ret = ft_find_next_prime(-50)) != 2)
        printf("\b\b\b\b\b\b\b\b\b\b\b\b\b\bKO, prime after -50 is 2, got %i", ret);
    else if ((time_bef = (time(NULL) - time_bef)) > 10)
        printf("\b\b\b\b\b\b\b\b\b\b\b\b\b\bKO, timeout! max time is 10 seconds, took %li", time_bef);
    else
