...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/02/13 21:02:53 by mtomomit          #+#    #+#             */
/*   Updated: 2022/02/13 23:00:04 by lservo           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void colup_endtwofour(char table[4][4], int table_core[4][4])
{
    ...
    while (i != 4)
    {
        if (table[0][i] == 51)
        {
            if (table_core[2][i] == 2 && table_core[3][i] == 4)
            {
                table_core[0][i] = 1;
                table_core[1][i] = 3;
            }
...
void coldown_endtwofour(char table[4][4], int table_core[4][4])
{
    ...
    while (i != 4)
    {
        if (table[1][i] == 51)
        {
            if (table_core[1][i] == 2 && table_core[0][i] == 4)
            {
                table_core[3][i] = 1;
                table_core[2][i] = 3;
            }
